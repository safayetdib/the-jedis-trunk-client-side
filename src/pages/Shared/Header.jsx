...
// 					<Typography variant="small" color="gray" className="font-primary">
		...
		<header className="p-2">
			<Navbar
				...
				<div className="relative mx-auto flex items-center justify-between text-blue-gray-900">
					<Link to="/">
						<Typography className="ml-2 mr-4 flex cursor-pointer items-center gap-2 py-1.5 font-secondary text-xl text-black">
							<FaJedi className="text-2xl" /> The Jedi&apos;s Trunk
						</Typography>
					</Link>
